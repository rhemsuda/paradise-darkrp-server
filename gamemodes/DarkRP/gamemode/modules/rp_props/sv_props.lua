-- TOP OF FILE (keep your existing header)
...
util.AddNetworkString("SyncResources") -- <== was missing

-- Try darkrp_modules path first, then fallback for legacy path
if file.Exists("darkrp_modules/inventory/sh_items.lua", "LUA") then
    include("darkrp_modules/inventory/sh_items.lua")
elseif file.Exists("modules/inventory/sh_items.lua", "LUA") then
    include("modules/inventory/sh_items.lua")
else
    print("[Props Module] WARNING: sh_items.lua not found; InventoryItems will be empty")
