...
function ENT:Initialize()
    ...
    self:SetNWString("ResourceType", "emerald") -- Set specific resource ID
...
function ENT:Use(activator, caller)
    ...
    print("[Debug] resource_emerald: Use called with resourceID = " .. tostring(resourceID) .. ", amount = " .. tostring(amount))
    if resourceID and resourceID != "" and amount > 0 then
        if SERVER then
            if AddResourceToInventory then
                print("[Debug] resource_emerald: Calling AddResourceToInventory for " .. activator:Nick() .. " with " .. resourceID .. " x" .. amount)
        ...
        print("[Debug] resource_emerald: Invalid resourceID or amount!")
    end
end